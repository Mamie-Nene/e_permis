...
import 'package:e_permis/src/utils/consts/app_specifications/app_dimensions.dart';
...
class AppResponseMessage  {
  ...
  void errorMessage( String errorMessage){
    createToastMessage(Colors.white,errorMessage,AppColors.error);
  }

  void successMessage(String? successMessage){
    createToastMessage(Colors.white,successMessage!,AppColors.primary);
  }

  void loadingMessage(String waitingMessage){
    createToastMessage(AppColors.onBackground,waitingMessage,Colors.white);
  }
            ...
            AlertDialog(
                ...
                actions: [
                  TextButton(
                      ...
                      child: Text('OUI',style: TextStyle(color:AppColors.primary,fontSize: MediaQuery.textScaleFactorOf(context)*17),)//20
                  ),
                  TextButton(
                    // onPressed:()=>Navigator.of(context).pop(),
                      onPressed:()=> Navigator.of(context).pop(false),
                      child: Text('NON',style: TextStyle(color:AppColors.primary,fontSize: MediaQuery.textScaleFactorOf(context)*17),)
                  )
                ],
