...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<String> _licenseOptions = ['Permis A', 'Permis B', 'Permis C', 'Permis D'];
  ...
  List<Candidate> get _visibleCandidates {
    return _candidates.where((candidate) {
      final bool matchesSearch = candidate.name.toLowerCase().contains(_searchController.text.toLowerCase());
      final bool matchesStatus = switch (_statusFilter) {
        'Évalués' => candidate.evaluated,
        'À évaluer' => !candidate.evaluated,
        _ => true,
      };
      final bool matchesLicense = _licenseFilter == null ? true : candidate.licenseType == _licenseFilter;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            if (_visibleCandidates.isEmpty)
              SliverFillRemaining(
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.fact_check_outlined, size: 48, color: Colors.grey[500]),
                      const SizedBox(height: 12),
              ...
              SliverList(
                delegate: SliverChildBuilderDelegate(
                    ...
                    return Padding(
                      padding: EdgeInsets.fromLTRB(16, 0, 16, index == _visibleCandidates.length - 1 ? 24 : 12),
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => Navigator.of(context).pushNamed(AppRoutesName.evaluationForm),
              ...
              ..._licenseOptions.map((license) {
                return Padding(
                  ...
                  child: FilterChip(
                    ...
                    onSelected: (_) {
                      setState(() {
                        _licenseFilter = _licenseFilter == license ? null : license;
                      });
                    },
                  ),
                );
            ...
            Row(
              ...
              children: [
                ...
                StatusPill(
                  ...
                  icon: isEvaluated ? Icons.verified_outlined : Icons.schedule_outlined,
                  backgroundColor: isEvaluated ? AppColors.primary.withOpacity(.1) : AppColors.secondaryMuted,
                  foregroundColor: isEvaluated ? AppColors.primary : AppColors.onSecondary,
                ),
              ],
            ),
            const SizedBox(height: 16),
