...
class CustomFormTextFieldForUsername extends StatelessWidget {
  ...
  const CustomFormTextFieldForUsername(
...
class CustomFormTextFieldForPassword extends StatelessWidget {
  ...
  const CustomFormTextFieldForPassword(
      {super.key,
...
class CustomTextfieldForMois extends StatelessWidget {
  ...
  const CustomTextfieldForMois({
    Key? key,
    required this.moisController,
    required this.textForBox,
    required this.svgIcons,
    this.action,
  }) : super(key: key);
